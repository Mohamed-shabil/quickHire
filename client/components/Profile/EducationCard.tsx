        ...
        <Card className="max-w-md">
            <CardHeader className="gap-4 flex-row">
                ...
                <div className="my-auto">
                    ...
                    <small className="text-slate-400">{education.degree}</small>
                </div>
            </CardHeader>
            <CardContent className="flex gap-2 text-slate-400 text-sm">
                <p className="font-medium">Grade : {education.grade}</p>
                <p>
                    {months[parseInt(education.startDate.startMonth)]}-
                    {education.endDate.endYear}
                </p>
                <p>/</p>
                <p>
                    {months[parseInt(education.endDate.endMonth)]}-
                    {education.endDate.endYear}
                </p>
            </CardContent>
            <Separator />
