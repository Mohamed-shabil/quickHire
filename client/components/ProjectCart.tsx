                ...
                <div className="my-auto">
                    ...
                    <small className="text-slate-400">
                        {project.skills.map((skill)=>(
                            <span className="whitespace-nowrap rounded-full capitalize bg-blue-500/15 px-2.5 py-0.5 text-sm text-blue-700 mx-1">
                                {skill}
                          </span>
                        ))}
                    </small>
                    ...
                    <DialogContent className="sm:max-w-[625px]">
                        ...
                        <div className="grid gap-4 py-4">
                            ...
                            <div className="grid grid-cols-4 gap-4">
                                ...
                                <div className="col-span-3 text-sm ">
                                    <Link href={project.links[0]} className="text-blue-500 flex ">{project.links[0]}<Url className="w-3"/></Link>
                                </div>
                            </div>
                        </div>
                    </DialogContent>
