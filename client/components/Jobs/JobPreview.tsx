      ...
      <div className="p-4 rounded-md mb-2 px-6">
        ...
        <section className="space-y-2 my-4 mt-6 ">
          <p className="font-normal text-base flex gap-2 items-center">
            <LocationIcon size={"1.2em"} className="text-blue-600" />{" "}
            {job.location}
          </p>
          <p className="font-normal text-base flex gap-2 items-center">
            <JobTypeIcon size={"1.2em"} className="text-blue-600" />{" "}
            {job.workPlace}
          </p>
          <p className="font-normal text-base flex gap-2 items-center">
            <EmploymentIcon size={"1.2em"} className="text-blue-600" />{" "}
            {job.employmentType}
          </p>
          <p className="font-normal text-base flex gap-2 items-center">
            <ExperienceIcon size={"1.2em"} className="text-blue-600" />
            <span className="bg-blue-500/10 p-1 rounded">
              <p className="text-blue-500 text-sm">{job.experience}</p>
            </span>
          </p>
          <p className="font-normal text-base flex gap-2 items-center">
            <OpeningsIcon size={"1.2em"} className="text-blue-600" />
            Openings - {job.openings}
          </p>
          <p className="font-normal text-base flex gap-2 items-center">
            <CashIcon size={"1.2em"} className="text-blue-600" />{" "}
            {currency.format(job.minSalary)} - {currency.format(job.maxSalary)}
          </p>
          <p className="font-normal text-base flex gap-2 items-center">
        ...
        <div>
          ...
          <div
            ...
            className="text-sm p-4 border rounded-md dark:text-white"
          ></div>
