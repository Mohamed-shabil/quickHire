...
function DeleteJobTrigger({job}:{job:Jobs}) {
    ...
    const deleteJob = (jobId:string)=>{
        axios.delete(`http://localhost:3005/api/jobs/${jobId}/delete-job`)
            .then((res)=>{
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                ...
                <AlertDialogDescription>
                    ...
                    job post and its related applications.
                </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                    <AlertDialogCancel>Cancel</AlertDialogCancel>
                    <AlertDialogAction onClick={()=>deleteJob(job._id)}>Delete</AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
        </AlertDialog>
    </>
