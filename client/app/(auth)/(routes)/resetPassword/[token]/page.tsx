...
const resetPassword = () => {
    ...
    const onSubmit = async(values : z.infer<typeof formSchema>)=>{
        console.log(values);
        axios.post(`http://localhost:3001/api/users/resetPassword/${params.token}`,values).then(res=>{
            console.log(res)
            toast({
            ...
            toast({
                ...
                description: err.response.data.errors[0].message || "Something went wrong try again after sometimes",
                action: (
        ...
        <>
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-lg">
                    <h1 className="text-center text-2xl font-bold text-blue-600 sm:text-3xl">Create New Password</h1>
