                                ...
                                <FormField
                                    ...
                                    render={() => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                Enter each skills and click the
                                                add button
                                            </FormDescription>
                                            <div className="flex flex-row">
                                                {skills.map((skill, index) => (
                                                    <span
                                                        className="flex flex-row w-min items-center  whitespace-nowrap rounded-full capitalize bg-blue-100 px-2.5 py-0.5 text-sm text-blue-700 mx-1"
                                                        key={index}
                                                    >
                                                        {skill}{" "}
                                                        <X
