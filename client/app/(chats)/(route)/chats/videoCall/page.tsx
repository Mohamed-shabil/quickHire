  ...
  return (
    <div>
      ...
      <AlertDialog open={answer}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Somebody is calling you</AlertDialogTitle>
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete your account
              and remove your data from our servers.
            </AlertDialogDescription>
      ...
      <div className="w-full h-[90vh] relative">
        {
          userVideo ?
          <video className='w-full h-full object-cover flex items-end justify-center' ref={userVideo} autoPlay muted></video> :
        ...
        <video ref={myVideo} autoPlay muted className='w-64 h-44 absolute top-3 left-2 object-fill rounded-md'/>
      </div>
    </div>
  )
}
