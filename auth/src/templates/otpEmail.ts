export const otpMail = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <section class="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
        ...
        <main class="mt-8">
            ...
            <div class="flex items-center mt-4 gap-x-4">
                <p class="flex items-center justify-center w-10 h-10 text-2xl font-medium text-blue-500 border border-blue-500 rounded-md dark:border-blue-400 dark:text-blue-400 ">****</p>
            </div>
